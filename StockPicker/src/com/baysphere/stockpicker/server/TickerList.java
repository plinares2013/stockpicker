...
public class TickerList extends HttpServlet {
	...
	public void doGet (HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		//TaskHandle handle = defaultQueue.add(TaskOptions.Builder.withUrl("/stockpicker/tickerlist").taskName(taskName).method(TaskOptions.Method.valueOf("POST")));
		TaskHandle handle = defaultQueue.add(TaskOptions.Builder.withUrl("/stockpicker/tickerlist").method(TaskOptions.Method.valueOf("POST")));
