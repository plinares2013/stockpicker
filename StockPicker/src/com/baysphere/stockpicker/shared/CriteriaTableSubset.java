...
public class CriteriaTableSubset implements IsSerializable {
		private double priceSalesLevel1;
		private int priceSalesLevel1Points;
		private double priceSalesLevel2;
		private int priceSalesLevel2Points;		
		private double priceSalesLevel3;		
		private int priceSalesLevel3Points;		
		private double priceSalesLevel4;		
		private int priceSalesLevel4Points;
				
		private double priceBookLevel1;		
		private int priceBookLevel1Points;		
		private double priceBookLevel2;		
		private int priceBookLevel2Points;		
		private double priceBookLevel3;		
		private int priceBookLevel3Points;		
		private double priceBookLevel4;		
		private int priceBookLevel4Points;		
		
		private double ProfitMarginLevel1;		
		private int ProfitMarginLevel1Points;		
		private double ProfitMarginLevel2;		
		private int ProfitMarginLevel2Points;		
		private double ProfitMarginLevel3;		
		private int ProfitMarginLevel3Points;		
		private double ProfitMarginLevel4;		
		private int ProfitMarginLevel4Points;	
				
		private double ROELevel1;		
		private int ROELevel1Points;		
		private double ROELevel2;		
		private int ROELevel2Points;		
		private double ROELevel3;		
		private int ROELevel3Points;		
		private double ROELevel4;		
		private int ROELevel4Points;		
		
		private double ROALevel1;		
		private int ROALevel1Points;		
		private double ROALevel2;		
		private int ROALevel2Points;		
		private double ROALevel3;		
		private int ROALevel3Points;		
		private double ROALevel4;		
		private int ROALevel4Points;		
		
		private double DebtEquityLevel1;		
		private int DebtEquityLevel1Points;		
		private double DebtEquityLevel2;		
		private int DebtEquityLevel2Points;		
		private double DebtEquityLevel3;		
		private int DebtEquityLevel3Points;		
		private double DebtEquityLevel4;		
		private int DebtEquityLevel4Points;
				
		private double CurrentLevel1;		
		private int CurrentLevel1Points;		
		private double CurrentLevel2;		
		private int CurrentLevel2Points;		
		private double CurrentLevel3;		
		private int CurrentLevel3Points;		
		private double CurrentLevel4;		
		private int CurrentLevel4Points;		
		
		private double OneYearEPSLevel1;		
		private int OneYearEPSLevel1Points;		
		private double OneYearEPSLevel2;		
		private int OneYearEPSLevel2Points;		
		private double OneYearEPSLevel3;		
		private int OneYearEPSLevel3Points;		
		private double OneYearEPSLevel4;		
		private int OneYearEPSLevel4Points;		
		
		private double QuarterlyEPSLevel1;		
		private int QuarterlyEPSLevel1Points;		
		private double QuarterlyEPSLevel2;		
		private int QuarterlyEPSLevel2Points;		
		private double QuarterlyEPSLevel3;		
		private int QuarterlyEPSLevel3Points;		
		private double QuarterlyEPSLevel4;		
		private int QuarterlyEPSLevel4Points;
				
		private double ManagementOwnershipLevel1;		
		private int ManagementOwnershipLevel1Points;		
		private double ManagementOwnershipLevel2;		
		private int ManagementOwnershipLevel2Points;		
		private double ManagementOwnershipLevel3;		
		private int ManagementOwnershipLevel3Points;		
		private double ManagementOwnershipLevel4;		
		private int ManagementOwnershipLevel4Points;		
		
		private double QuickRatioLevel1;		
		private int QuickRatioLevel1Points;		
		private double QuickRatioLevel2;		
		private int QuickRatioLevel2Points;		
		private double QuickRatioLevel3;		
		private int QuickRatioLevel3Points;		
		private double QuickRatioLevel4;		
		private int QuickRatioLevel4Points;		
		
		private double PEGRatioLevel1;		
		private int PEGRatioLevel1Points;		
		private double PEGRatioLevel2;		
		private int PEGRatioLevel2Points;		
		private double PEGRatioLevel3;		
		private int PEGRatioLevel3Points;		
		private double PEGRatioLevel4;		
		private int PEGRatioLevel4Points;		
		
		private double EPSQuarterlyGrowthYoYLevel1;		
		private int EPSQuarterlyGrowthYoYLevel1Points;		
		private double EPSQuarterlyGrowthYoYLevel2;		
		private int EPSQuarterlyGrowthYoYLevel2Points;		
		private double EPSQuarterlyGrowthYoYLevel3;		
		private int EPSQuarterlyGrowthYoYLevel3Points;		
		private double EPSQuarterlyGrowthYoYLevel4;		
		private int EPSQuarterlyGrowthYoYLevel4Points;		
		
		private double PERatioLevel1;		
		private int PERatioLevel1Points;		
		private double PERatioLevel2;		
		private int PERatioLevel2Points;		
		private double PERatioLevel3;		
		private int PERatioLevel3Points;	
		private double PERatioLevel4;	
		private int PERatioLevel4Points;
